...
public class QuestionController {
	...
	@GetMapping("/questions/{qGenre}/{modeId}")
	public List<Question> getQuestion(@PathVariable String qGenre,@PathVariable int modeId) {
		return questionservice.getQuestion(qGenre,modeId);
	}
